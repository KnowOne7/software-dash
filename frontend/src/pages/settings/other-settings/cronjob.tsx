            ...
            <div className="xl:col-span-9">
              <div className="bg-white border border-borderColor rounded p-4">
                <div className="border-b border-borderColor mb-3 pb-3">
                  <h5 className="mb-0 text-[17px]">Cronjob</h5>
                </div>
                {/* start row */}
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-4 gap-x-4 items-center mb-4">
                  <div className="lg:col-span-6">
                    <h6 className="mb-1 text-[14px]">Cronjob Link</h6>
                    <p className="text-[13px] mb-0">You can configure the Link</p>
                  </div>
                  <div className="lg:col-span-6">
                    <div className="mb-0">
                      <input
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-4 gap-x-4 items-center mb-4">
                  <div className="lg:col-span-6">
                    <h6 className="mb-1 text-[14px]">Execution Interval</h6>
                    <p className="text-[13px] mb-0">You can configure the intervals</p>
                  </div>
                  <div className="lg:col-span-6">
                    <div className="mb-0">
                      <input
                ...
                {/* end row */}
                <div className="flex items-center justify-end gap-2 border-t border-borderColor pt-4">
