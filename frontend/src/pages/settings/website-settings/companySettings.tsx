        ...
        <div className="xl:col-span-9">
          <div className="bg-white border border-borderColor rounded p-4">
            <div className="border-b border-borderColor mb-3 pb-3">
              <h5 className="mb-0 text-[17px]">Company Settings</h5>
            </div>
            <form>
              <div className="mb-3">
                <h6 className="mb-1">Company Information</h6>
                <p className="mb-0">Provide the company information below</p>
              </div>
              <div className="border-b border-borderColor pb-1 mb-4">
                {/* start row */}
