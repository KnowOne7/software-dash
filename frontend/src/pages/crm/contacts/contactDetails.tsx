...
import ContactDetailsModals from "./contactModal/contactDetailsModals";
    ...
    <>
      ...
      <div className="page-wrapper relative pt-[50px] ml-[240px]">
        <div className="content p-5">
          ...
          <div>
            <div className="mb-3">
              <Link to={all_routes.contactGrid} className="hover:text-primary">
                ...
                <div className="w-full">
                  <div className="bg-white border border-borderColor rounded">
                    <div className="p-4">
                      ...
                      <div className="mb-3">
                        <div>
                          <h6 className="flex text-[14px] items-center font-medium mb-3">
                            <Link
                              to={all_routes.contactDetails}
                              className="avatar w-10 h-10 rounded border border-borderColor flex items-center justify-center p-1 me-2"
                            >
                              <ImageWithBasePath
                            ...
                            <span>
                              <Link
                                to={all_routes.contactDetails}
                                className="flex item-center gap-2 mb-1"
                              >
                                Google.Inc
