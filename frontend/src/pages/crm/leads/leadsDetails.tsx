...
import LeadsDetailsModal from "./modal/leadsDetailsModal";
      ...
      <div className="page-wrapper relative pt-[50px] ml-[240px]">
        <div className="content p-5">
          ...
          <div className="mb-4">
            <Link
              to={all_routes.leads}
              className="inline-flex items-center text-dark"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
            {/* Left column: span 4/12 on large screens */}
            <div className="lg:col-span-4">
              <div className="bg-white border border-borderColor rounded p-4 w-full">
                <h6 className="mb-4 font-semibold">Leads Information</h6>
            ...
            <div className="lg:col-span-8">
              <div className="w-full">
                <div className="border-b border-borderColor pb-5 mb-5">
                  <h5 className="mb-3">Leads Pipeline Status</h5>
                  <ul className="flex item-center mb-4 media-max-xs:flex media-max-xs:flex-col">
                    ...
                    <li className="inline-block media-max-xs:block">
                      <Link
                        to="#"
                        className="relative flex items-center justify-center text-white text-center text-[14px] font-medium rounded-tl-[10px] rounded-bl-[10px] 
                                  inline-block mb-[3px] pt-[12px] pr-[25px] pb-[12px] pl-[30px] bg-info-600 after:z-[1] after:content-[''] min-w-[150px]
                                  after:absolute after:top-0 after:right-[-23px] after:w-[45px] after:h-[45px] after:scale-[0.707] 
                                  after:rotate-[45deg] after:bg-info-600 after:shadow-custom_shadow media-max-xs:w-full"
                      >
                        Contacted
                      </Link>
                    </li>
                    <li className="inline-block media-max-xs:block">
                      <Link
                        to="#"
                        className="relative flex items-center justify-center text-white text-center text-[14px] font-medium rounded-tl-[10px] rounded-bl-[10px] 
                                  inline-block mb-[3px] pt-[12px] pr-[25px] pb-[12px] pl-[30px] bg-success after:z-[1] after:content-[''] min-w-[150px]
                                  after:absolute after:top-0 after:right-[-23px] after:w-[45px] after:h-[45px] after:scale-[0.707] 
                                  after:rotate-[45deg] after:bg-success after:shadow-custom_shadow media-max-xs:w-full"
                      >
                        Closed
                      </Link>
                    </li>
                          ...
                          <div className="flex items-center justify-between gap-3 xl:flex-nowrap flex-wrap">
                            <div>
                              ...
                              <p>
                                ...
                                contracts to close Leads faster
                              </p>
                            </div>
                            <Link
