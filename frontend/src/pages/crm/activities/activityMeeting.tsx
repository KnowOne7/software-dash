...
import { ActivitiesMeetingsData } from "../../../core/json/activitiesListData";
...
const ActivitiesMeetings = () => {
  ...
  const data = ActivitiesMeetingsData;
  const columns = [
    {
      title: "Titel",
      dataIndex: "Title",
                ...
                <div className="flex items-center flex-wrap gap-y-3">
                  <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <Link
                      ...
                      className="btn border border-primary btn-icon btn-outline-light shadow bg-primary text-white"
...
export default ActivitiesMeetings;
