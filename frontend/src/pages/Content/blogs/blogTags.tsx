...
const BlogTags = () => {
  ...
  const data = blogTagsListData;
    // Get actions for payments page
        const blogTagsActions = getActionsForPage("blogTags");
        const actionColumn = useActionColumn(blogTagsActions);
  const columns = [
    {
      title: "Tag Name",
      dataIndex: "Tag_Name",
    ...
    <div className="relative p-4 w-full max-w-[500px] max-h-full">
      <div className="relative bg-white rounded-defaultradius">
        <div className="flex items-center justify-between p-4 border-b border-borderColor">
          <h5 className="font-bold text-[18px]">Add Blog Tag</h5>
          <button
            type="button"
  ...
  >
    <div className="relative p-4 w-full max-w-[500px] max-h-full">
      <div className="relative bg-white rounded-defaultradius">
        <div className="flex items-center justify-between p-4 border-b border-borderColor">
          <h5 className="font-bold text-[18px]">Edit Blog Tag</h5>
          <button
            type="button"
            className="text-danger hover:text-danger text-sm w-6 h-6 border border-borderColor bg-danger-100 rounded-full absolute top-3 end-3 flex items-center justify-center"
      ...
      <div className="modal-content rounded-0">
        <div className="modal-body p-4 text-center">
          ...
          <div className="flex justify-center items-center">
            ...
            <Link to={all_routes.blogTags} className="btn btn-primary z-1 w-full">
              Yes, Delete
            </Link>
          </div>
        </div>
