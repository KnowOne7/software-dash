...
import { Assignee, City, Company_Name, Contacts, Country, Currency, Deals, Industry, Language, Owner, Period, Pipeine, Priority, Source, State, StatusActive } from "../../../../core/json/selectOption";
