...
const ProjectDetails = () => {
  ...
  <div className="page-wrapper relative pt-[50px] ml-[240px]">
    <div className="content p-5">
      ...
      {/* End Page Header */}
      <div className="mb-4">
        <Link to={all_routes.projectsGrid} className="inline-flex items-center text-dark">
        ...
        <div className="card-body p-4">
          <div className="flex items-center justify-between flex-wrap">
            <div className="flex items-center mb-2">
              <div className="w-[80px] h-[80px] rounded-full p-2 border border-borderColor me-4 flex-shrink-0">
                <ImageWithBasePath
              ...
              <div>
                ...
                <p className="mb-2">
                  {" "}
                  Project Id :{" "}
                  <span className="text-dark font-medium">154454887</span>{" "}
                </p>
                <div className="flex items-center">
                  ...
                  <span className="px-1.5 py-0.5 rounded text-[12px] text-white inline-flex bg-success items-center me-2">
                    Active
                  </span>
                </div>
              </div>
            ...
            <div className="flex items-center flex-wrap gap-2">
              ...
              <div className="relative">
                ...
                <div
                  id="statusDropdown"
                  className="hidden absolute right-0 w-[150px] bg-white border border-borderColor rounded shadow z-10"
                >
                  <Link
                    to="#"
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-y-4 gap-x-4">
        <div className="xl:col-span-4">
          <div className="bg-white border border-borderColor rounded">
            <div className="p-4">
              <h6 className="mb-4 font-semibold">Project Information</h6>
              ...
              <div className="border-b border-borderColor pb-5 mb-5">
                ...
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <p className="mb-0 text-sm text-gray-800">Trulysell</p>
                  </div>
                </div>
                <h6 className="mb-4 font-semibold flex items-center justify-between">
                  Responsible Persons
              ...
              <div className="border-b border-borderColor pb-5 mb-5">
                <h6 className="mb-4 font-semibold flex items-center justify-between">
                  Pipeline
                  <span className="font-medium text-dark text-[14px] flex items-center">
