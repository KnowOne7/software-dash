...
const ContactList = () => {
  const paymentsActions = getActionsForPage('contacts');
  ...
  const columns = [
    {
      ...
      render: (_: any, record: any) => (
        <div
          className={`cursor-pointer ${filledStars[record.Name] ? "text-yellow-500" : "text-gray-300"
            }`}
    ...
    },
    {
      ...
      render: (text: string, render: any) => (
        <h6 className="flex items-center text-sm font-medium mb-0">
          <Link to={all_routes.contactDetails} className="mr-2">
            <ImageWithBasePath
          ...
          <Link to={all_routes.contactDetails} className="flex flex-col">
            {text}
            <span className="text-gray-500 text-xs mt-1">{render.role}</span>
          </Link>
        </h6>
      ),
      sorter: (a: any, b: any) => a.Name.length - b.Name.length,
    },
    {
      ...
      render: (text: any) => (
        <span
          className={`px-2 py-1 rounded text-xs font-medium ${text === "Collab"
    ...
    },
    {
      ...
      render: (text: any) => (
        <div className="flex items-center">
          <i className="ti ti-star-filled text-yellow-400 mr-1" /> {text}
        </div>
      ),
    ...
    },
    {
      ...
      render: () => (
        <ul className="flex items-center space-x-3">
          <li>
            <Link to="#">
              <i className="ti ti-mail text-gray-500 hover:text-blue-500" />
            </Link>
          </li>
          <li>
            <Link to="#">
              <i className="ti ti-phone-check text-gray-500 hover:text-green-500" />
            </Link>
          </li>
          <li>
            <Link to="#">
              <i className="ti ti-message-circle-share text-gray-500 hover:text-indigo-500" />
            </Link>
          </li>
          <li>
            <Link to="#">
              <i className="ti ti-brand-facebook text-gray-500 hover:text-blue-600" />
            </Link>
          </li>
        </ul>
      ),
    ...
    },
    {
      ...
      render: (text: any) => (
        <span
          className={`px-2 py-1 rounded text-xs font-semibold ${text === "Active"
                    ...
                    >
                      ...
                      <div id="accordionExample" data-accordion="collapse" className="p-4">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Link to={all_routes.contactList} className="btn btn-primary w-full">
                            Filter
                          </Link>
                        </div>
                      </div>
