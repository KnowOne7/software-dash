...
export default function DemoPage() {
  ...
  return (
    <div style={{ padding: 16 }}>
      <h2>{demo.title}</h2>
      <ReactECharts option={demo.option} style={{ height: 600, width: "100%" }} />
    </div>
  );
}
        ...
        <div className="content p-5 pb-0">
          ...
          <div className="md:grid grid-cols-2 gap-x-6">
            ...
            <div className="col-span-1">
              <div className="card border-borderColor rounded-[5px] shadow-sm bg-white mb-6">
                <div className="card-header py-4 px-5 border-b border-borderColor">
                  <h4 className="card-title">Apex Simple</h4>
                </div>
            ...
            <div className="col-span-1">
              <div className="card border-borderColor rounded-[5px] shadow-sm bg-white mb-6">
                <div className="card-header py-4 px-5 border-b border-borderColor">
                  <h4 className="card-title">Column Stacked Chart</h4>
                </div>
                <div className="card-body p-5">
                <ReactApexChart
                  options={sColStacked}
