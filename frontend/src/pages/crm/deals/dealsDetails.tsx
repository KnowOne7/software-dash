...
import DealsDetailsModal from "./modal/dealsDetailsModal";
    ...
    <>
      ...
      <div className="page-wrapper relative pt-[50px] ml-[240px]">
        <div className="content p-5">
          ...
          {/* End Page Header */}
          <div className="mb-4">
            <Link to={all_routes.dealsList} className="flex items-center text-dark">
              <i className="ti ti-arrow-narrow-left mr-1" />
              Back to Deals
            </Link>
          </div>
          {/* User Item */}
          <div className="bg-white p-4 border border-borderColor rounded mb-4">
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div className="flex items-center flex-wrap lg:flex-nowrap md:flex-nowrap gap-y-3">
                <div className="w-20 h-20 flex items-center justify-center rounded-full border border-warning bg-warning-100 me-3 shrink-0">
                  <h6 className="mb-0 text-warning">HT</h6>
                </div>
                <div>
                  <h5 className="mb-1 flex items-center">
                    Tremblay and Rath
                    <i className="ti ti-star-filled text-warning ms-1" />
                  </h5>
                  <p className="mb-1 flex items-center text-sm">
                    <i className="ti ti-building-skyscraper me-1" />
                    Google Inc
                  </p>
                  <p className="mb-0 flex items-center text-sm">
              ...
              <div className="flex items-center flex-wrap gap-2">
                <span className="py-1.5 px-2.5 text-xs bg-danger-100 rounded text-danger font-medium flex items-center">
                ...
                <div className="relative">
                  <button
                    type="button"
                    className="text-xs py-1.5 px-2.5 text-xs bg-success rounded text-white font-medium flex items-center outline-none"
                  ...
                  <div
                    id="statusDropdown"
                    className="hidden absolute right-0 w-[100px] bg-white border border-borderColor rounded shadow z-10"
                  >
                    <Link
                      to="#"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
            ...
            <div className="xl:col-span-4 lg:col-span-4">
              <div className="bg-white border border-borderColor rounded p-4 w-full">
                <h6 className="mb-4 font-semibold">Deals Information</h6>
                <div className="border-b border-borderColor pb-5 mb-5">
                  <div className="flex items-center justify-between gap-2 flex-wrap mb-2">
                    <p>Date Created</p>
                    <p className="text-dark">27 Sep 2025, 11:45 PM</p>
                  </div>
                  <div className="flex items-center justify-between gap-2 flex-wrap mb-2">
                    <p>Probability - Win</p>
                  ...
                  <div className="flex items-center justify-between gap-2 flex-wrap mb-2">
                    <p>Deal Value</p>
                    <p className="text-dark">$25,11,145</p>
                  </div>
                  <div className="flex items-center justify-between gap-2 flex-wrap mb-2">
                    <p>Due Date</p>
                    <p className="text-dark">27 Sep 2025, 11:45 PM</p>
                  ...
                  <div className="flex items-center justify-between gap-2 flex-wrap mb-2">
                    <p>Follow Up</p>
                    <p className="text-dark">27 Sep 2025</p>
                  </div>
                  <div className="flex items-center justify-between gap-2 flex-wrap mb-2">
                    <p>Source</p>
                ...
                <h6 className="mb-4 font-semibold flex items-center justify-between">
                  ...
                  <button
                    ...
                    data-modal-target="add_new"
                    data-modal-toggle="add_new"
                  >
                ...
                <div className="border-b border-borderColor pb-5 mb-5">
                  <div className="flex items-center mb-3">
                    <span className="w-6 h-6 rounded-full overflow-hidden mr-2 flex-shrink-0">
                      <ImageWithBasePath
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="mb-0 text-sm text-gray-800">Jessica Sen</p>
                    </div>
                  </div>
                </div>
                {/* Item */}
                ...
                <div className="border-b border-borderColor pb-5 mb-5">
                  <Link
                    to="#"
                    className="badge badge-pill badge-status px-1.5 py-0.5 rounded text-[12px] bg-success-100 text-success border-b border-success me-2"
                  >
                    Collab
                  </Link>
                  <Link
                    to="#"
                    className="badge badge-pill badge-status px-1.5 py-0.5 rounded text-[12px] bg-warning-100 text-warning border-b border-warning"
                  >
                    VIP
                  </Link>
                </div>
                ...
                <div className="border-b border-borderColor pb-5 mb-5">
                  <Link
                    to="#"
                    className="badge badge-pill badge-status px-1.5 py-0.5 rounded text-[12px] text-body font-medium border border-borderColor me-2"
                  >
                    Devops Design
                  </Link>
                  <Link
                    to="#"
                    className="badge badge-pill badge-status px-1.5 py-0.5 rounded text-[12px] text-body font-medium border border-borderColor"
                  >
                    Margrate Design
                  </Link>
                </div>
            ...
            <div className="xl:col-span-8 lg:col-span-8">
              <div className="w-full">
                <div className="border-b border-borderColor pb-5 mb-5">
                  ...
                  <ul className="flex item-center media-max-xs:flex media-max-xs:flex-col flex-wrap gap-y-1">
                    <li className="inline-block media-max-xs:block">
                      <Link
                        to="#"
                        className="relative flex items-center justify-center text-white text-center text-[14px] font-medium rounded-tl-[10px] rounded-bl-[10px] 
                                  inline-block mb-[3px] pt-[12px] pr-[25px] pb-[12px] pl-[30px] bg-indigo after:z-[1] after:content-[''] min-w-[150px]
                                  after:absolute after:top-0 after:right-[-23px] after:w-[45px] after:h-[45px] after:scale-[0.707] 
                                  after:rotate-[45deg] after:bg-indigo after:shadow-custom_shadow media-max-xs:w-full"
                      >
                        Quality To Buy
                      </Link>
                    </li>
                    <li className="inline-block media-max-xs:block">
                      <Link
                        to="#"
                        className="relative flex items-center justify-center text-white text-center text-[14px] font-medium rounded-tl-[10px] rounded-bl-[10px] 
                                  inline-block mb-[3px] pt-[12px] pr-[25px] pb-[12px] pl-[30px] bg-warning after:z-[1] after:content-[''] min-w-[150px]
                                  after:absolute after:top-0 after:right-[-23px] after:w-[45px] after:h-[45px] after:scale-[0.707] 
                                  after:rotate-[45deg] after:bg-warning after:shadow-custom_shadow media-max-xs:w-full"
                      >
                        Contact Made
                      </Link>
                    </li>
                    <li className="inline-block media-max-xs:block">
                      <Link
                        to="#"
                        className="relative flex items-center justify-center text-white text-center text-[14px] font-medium rounded-tl-[10px] rounded-bl-[10px] 
                                  inline-block mb-[3px] pt-[12px] pr-[25px] pb-[12px] pl-[30px] bg-danger after:z-[1] after:content-[''] min-w-[150px]
                                  after:absolute after:top-0 after:right-[-23px] after:w-[45px] after:h-[45px] after:scale-[0.707] 
                                  after:rotate-[45deg] after:bg-danger after:shadow-custom_shadow media-max-xs:w-full"
                      >
                        Presentation
                      </Link>
                    </li>
                    <li className="inline-block media-max-xs:block">
                      <Link
                        to="#"
                        className="relative flex items-center justify-center text-white text-center text-[14px] font-medium rounded-tl-[10px] rounded-bl-[10px] 
                                  inline-block mb-[3px] pt-[12px] pr-[25px] pb-[12px] pl-[30px] bg-pink after:z-[1] after:content-[''] min-w-[150px]
                                  after:absolute after:top-0 after:right-[-23px] after:w-[45px] after:h-[45px] after:scale-[0.707] 
                                  after:rotate-[45deg] after:bg-pink after:shadow-custom_shadow media-max-xs:w-full"
                      >
                        Proposal Made
                      </Link>
                    </li>
                    <li className="inline-block media-max-xs:block">
                      <Link
                        to="#"
                        className="relative flex items-center justify-center text-dark text-center text-[14px] font-medium rounded-tl-[10px] rounded-bl-[10px] 
                                  inline-block mb-[3px] pt-[12px] pr-[25px] pb-[12px] pl-[30px] bg-gray-100 after:z-[1] after:content-[''] min-w-[150px]
                                  after:absolute after:top-0 after:right-[-23px] after:w-[45px] after:h-[45px] after:scale-[0.707] 
                                  after:rotate-[45deg] after:bg-gray-100 after:shadow-custom_shadow media-max-xs:w-full"
                      >
                        Appointment
                      </Link>
                    </li>
                ...
                {/* start tab */}
                <ul
                  className="flex-wrap flex bg-white rounded border border-borderColor gap-x-2 px-3 pt-1 mb-4"
                      ...
                      <div className="p-4">
                          ...
                          <div className="flex items-center justify-between gap-3 lg:flex-nowrap flex-wrap mb-4">
                            ...
                            <div className="flex items-center gap-2 flex-wrap">
                              <div className="dropdown relative table-action">
                                ...
                                <div
                                  id="dropdown-menu-1"
                                  className="hidden absolute end-0 w-[150px] z-[1] p-2 border border-borderColor rounded bg-white shadow-lg dropdown-menu"
                                >
                                  <Link
                                    className="rounded p-2 flex items-center hover:bg-primary-transparent hover:text-primary text-gray-900"
                                    to="#"
                        ...
                        <div className="border border-borderColor rounded p-4">
                          <div className="flex items-center justify-between gap-3 lg:flex-nowrap flex-wrap mb-4">
                            ...
                            <div className="flex items-center gap-2 flex-wrap">
                              <div
                                className="dropdown relative table-action"
                            ...
                            <div className="flex items-center gap-2 flex-wrap">
                              ...
                              <div className="dropdown relative table-action">
                                <Link
                                  to="#"
                                  className="dropdown-toggle w-8 h-8 flex items-center border border-borderColor rounded shadow btn-icon btn-outline-light"
                                  data-dropdown-toggle="dropdown-menu-busy"
                                >
                                  <i className="ti ti-dots-vertical" />
                                </Link>
                                <div
                                  id="dropdown-menu-busy"
                                  className="hidden absolute end-0 w-[150px] z-[1] p-2 border border-borderColor rounded bg-white shadow-lg dropdown-menu"
                                >
                                  <Link
                                    className="rounded p-2 flex items-center hover:bg-primary-transparent hover:text-primary text-gray-900"
                            ...
                            <div className="flex items-center gap-2 flex-wrap">
                              ...
                              <div className="dropdown relative table-action">
                                <Link
                                  to="#"
                                  className="dropdown-toggle w-8 h-8 flex items-center border border-borderColor rounded shadow btn-icon btn-outline-light"
                                  data-dropdown-toggle="call-dropdown-2"
                                >
                                  <i className="ti ti-dots-vertical" />
                                </Link>
                                <div
                            ...
                            <div className="flex items-center gap-2 flex-wrap">
                              ...
                              <div className="dropdown relative table-action">
                                <Link
                                  to="#"
                                  className="dropdown-toggle w-8 h-8 flex items-center border border-borderColor rounded shadow btn-icon btn-outline-light"
                                  data-dropdown-toggle="call-dropdown-3"
                                >
                                  <i className="ti ti-dots-vertical" />
                                </Link>
                                <div
                            ...
                            <div className="flex items-center gap-2 flex-wrap ">
                              ...
                              <div className="dropdown relative table-action">
                                <Link
                                  to="#"
                                  className="dropdown-toggle w-8 h-8 flex items-center border border-borderColor rounded shadow btn-icon btn-outline-light"
                                  data-dropdown-toggle="draft-dropdown"
                                >
                                  <i className="ti ti-dots-vertical" />
                                </Link>
                                <div
                            ...
                            <div className="flex items-center gap-2 flex-wrap">
                              ...
                              <div className="dropdown relative table-action">
                                <Link
                                  to="#"
                                  className="dropdown-toggle w-8 h-8 flex items-center border border-borderColor rounded shadow btn-icon btn-outline-light"
                                  data-dropdown-toggle="draft-dropdown-2"
                                >
                                  <i className="ti ti-dots-vertical" />
                                </Link>
                                <div
                            ...
                            <div className="flex items-center gap-2 flex-wrap">
                              <div className="dropdown relative table-action">
                                <Link
                                  to="#"
                                  className="dropdown-toggle w-8 h-8 flex items-center border border-borderColor rounded shadow btn-icon btn-outline-light"
                                  data-dropdown-toggle="draft-dropdown-3"
                                >
                                  <i className="ti ti-dots-vertical" />
                                </Link>
                                <div
