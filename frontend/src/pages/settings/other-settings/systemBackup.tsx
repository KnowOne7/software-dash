            ...
            <div className="xl:col-span-9">
              <div className="bg-white border border-borderColor rounded p-4">
                <div className="border-b border-borderColor flex items-center justify-between mb-3 pb-3">
                  <h5 className="mb-0 text-[17px]">System Backup</h5>
                  <Link
                    to="#"
                ...
                <div className="table-responsive custom-table">
                  <table className="table table-nowrap w-full">
                    ...
                    <tbody>
                      <tr>
                        <td className="p-3">crm_customers_backup_2025-05-26</td>
                      ...
                      <tr>
                        <td className="p-3">crms_reports_export_2025-05-26</td>
                      ...
                      <tr>
                        <td className="p-3">crms_projects_export_2025-05-26</td>
                      ...
                      <tr>
                        <td className="p-3">crms_companies_export_2025-05-26</td>
