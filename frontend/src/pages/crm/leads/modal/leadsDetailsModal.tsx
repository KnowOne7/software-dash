...
import { AccountType, DocumentType, Leads, Owner, State, Status_Busy } from "../../../../core/json/selectOption"
import CommonSelect from "../../../../components/common-select/commonSelect"
import CommonDatePicker from "../../../../components/common-date-picker/commonDatePicker"
import { all_routes } from "../../../../routes/all_routes"


const LeadsDetailsModal = () => {
  return (
    <>
  {/* start add new  modal */}
  <div
      ...
      <div className="relative bg-white rounded-defaultradius">
        <div className="flex items-center justify-between p-4 border-b border-borderColor">
          <div className="flex item-center gap-2">
            <h5 className="font-bold text-[18px]">Add Leads Owner</h5>
          </div>
          <button
            type="button"
      ...
      <div className="modal-content rounded-0">
        <div className="modal-body p-4 text-center">
          ...
          <div className="flex justify-center items-center">
            ...
            <Link to={all_routes.leadsDetails} className="btn btn-primary z-1 w-full">
              Yes, Delete
            </Link>
          </div>
        </div>
