...
import { AccountType, Deals, DocumentType, Owner, Status_Busy } from "../../../../core/json/selectOption"
import CommonDatePicker from "../../../../components/common-date-picker/commonDatePicker"
import { all_routes } from "../../../../routes/all_routes"


const DealsDetailsModal = () => {
      ...
      <div className="relative bg-white rounded-defaultradius">
        <div className="flex items-center justify-between p-4 border-b border-borderColor">
          <div className="flex item-center gap-2">
            <h5 className="font-bold text-[18px]">Add Deal Owner</h5>
          </div>
          <button
            type="button"
              ...
              <label className="flex items-center space-x-2 text-gray-700 cursor-pointer">
                ...
                <span className="flex items-center space-x-2">
                  <ImageWithBasePath
                    ...
                    className="h-8 w-8 rounded-full"
                  />
                  <span className="text-dark font-medium"> Sharon Roy</span>
                </span>
              </label>
            </div>
            <div className="mb-4">
              <label className="flex items-center space-x-2 text-gray-700 cursor-pointer">
                ...
                <span className="flex items-center space-x-2">
                  <ImageWithBasePath
                    ...
                    className="h-8 w-8 rounded-full"
                  />
                  <span className="text-dark font-medium">Vaughan Lewis</span>
                </span>
              </label>
            </div>
            <div className="mb-4">
              <label className="flex items-center space-x-2 text-gray-700 cursor-pointer">
                ...
                <span className="flex items-center space-x-2">
                  <ImageWithBasePath
                    ...
                    className="h-8 w-8 rounded-full"
                  />
                  <span className="text-dark font-medium"> Jessica Louise</span>
                </span>
              </label>
            </div>
            <div>
              <label className="flex items-center space-x-2 text-gray-700 cursor-pointer">
                ...
                <span className="flex items-center space-x-2">
                  <ImageWithBasePath
                    ...
                    className="h-8 w-8 rounded-full"
                  />
                  <span className="text-dark font-medium"> Carol Thomas</span>
                </span>
              </label>
            </div>
          </form>
              ...
              <form>
                <div className="grid grid-cols-1 md:grid-cols-12 gap-y-4 gap-x-4 mb-4">
                  <div className="md:col-span-12">
                    <div>
                      <label className="form-label">
                        Choose Deal<span className="text-danger ms-1">*</span>
                      </label>
                      <CommonSelect
                            options={Deals}
                            className="select"
      ...
      <div className="modal-content rounded-0">
        <div className="modal-body p-4 text-center">
          ...
          <div className="flex justify-center items-center">
            ...
            <Link to={all_routes.dealsDetails} className="btn btn-primary z-1 w-full">
              Yes, Delete
            </Link>
          </div>
        </div>
