...
import CompanyReportModal from "./modal/companyReportModal";
import CommonFooter from "../../../components/common-footer/commonFooter";
import PredefinedDatePicker from "../../../components/common-date-range-picker/PredefinedDatePicker";
import CompanyYearChart from "../../main-menu/dashboard/deals-dashboard/charts/companyReportChart";
      ...
      render: (text: string, render: any) => (
        <h6 className="flex items-center text-sm font-medium mb-0">
          <Link
            ...
            className="w-8 h-8 mr-2 border rounded-full flex-shrink-0 overflow-hidden"
          >
            <ImageWithBasePath
    ...
    },
    {
      ...
      render: (text: any, render: any) => (
        <h6 className="flex items-center text-sm font-medium mb-0">
          <Link
            to="#"
            className="w-7 h-7 mr-2 rounded-full border flex-shrink-0 overflow-hidden"
          >
            <ImageWithBasePath
        ...
        <div className="content p-5">
          ...
          <div className="flex flex-col md:flex-row md:gap-6">
            <div className="w-full md:w-7/12 flex mb-5">
              <div className="bg-white border-borderColor rounded-lg shadow-sm flex flex-col w-full">
                <div className="flex items-center justify-between gap-3 py-3 px-4 border-b border-borderColor">
                  <h6 className="m-0">Companies By Year</h6>
                  {/* Dropdown */}
                  <div>
                    <Link
                      to="#"
            ...
            <div className="w-full md:w-5/12 flex mb-5">
              <div className="bg-white border-borderColor rounded-lg shadow-sm flex flex-col w-full">
                <div className="flex items-center justify-between gap-3 py-3 px-4 border-b border-borderColor">
                  <h6 className="m-0">Companies By Source</h6>
                  {/* Dropdown */}
                  <div>
                    <Link
                      to="#"
